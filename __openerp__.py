...
""",
    ...
    "data": [
        ...
        #"security/ir.model.access.csv", #Moved to .xml
        "security/ir.model.access.xml",

        #Data
        "data/crm.case.stage.xml", #Hide Lead column

        "data/account.account-base.xml",
        "data/account.account-strategy.xml",
        "data/account.account-s&o.xml",
        "data/account.account-training.xml",
